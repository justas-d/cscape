namespace CScape.Core.Json.Model
{
    public interface IInterfaceIdDatabase
    {
        ...
        byte BackpackSidebarIdx { get; }
        byte CombatStyleSidebarIdx { get; }
        int ControlsSidebar { get; }
        byte ControlsSidebarIdx { get; }
