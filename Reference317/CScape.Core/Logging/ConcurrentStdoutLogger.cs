...
namespace CScape.Core.Logging
{
    public class ConcurrentStdoutLogger : ILogger
    {
        ...
        public ConcurrentStdoutLogger([NotNull] IServiceProvider services)
        {
        ...
        {
            var time = log.Time - _server.UTCStartTime;
#if DEBUG
